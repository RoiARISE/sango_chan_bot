...
class MyBot:
    ...
    def _on_timeline_note(self, note):
        ...
        CONTEXT_LIMIT = 5 # 👈 前後に5文字まで許容 (この数字は自由に変更してください)
        ...
        timeline_keywords = [
            ...
            # --- "partial" (部分一致) ---
            ( ("疲れた", "つかれた", "疲れてる", "つかれてる", "疲れている", "つかれている"), "ひとやすみ、する？", None, "partial"),
            ( ("出勤",), responses.get_random_response('go_work'), None, "partial"),
            ( ("退勤", "しごおわ"), "お仕事終わったの？ お疲れさま～。", None, "partial"),

            # --- "context" (前後5文字まで許容) ---
            ( ("眠い", "眠たい", "ねむ"), "なるほど、眠いんだね...", False, "context"),
